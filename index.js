...
const totalraisedString = `A total of ${totalRaised.toLocaleString('en-US')} has been raised for ${GAMES_JSON.length} games. Currently, ${unfundedGamesCount} ${unfundedGamesCount === 1 ? "game remains unfunded." : "games remain unfunded. We need your help to fund these amazing games!"}`;
;   

// create a new DOM element containing the template string and append it to the description container
const unfundedGamesElement = document.createElement("p");
const totalRaisedElement = document.createElement("p");
totalRaisedElement.innerHTML = totalraisedString;
descriptionContainer.appendChild(totalRaisedElement);
